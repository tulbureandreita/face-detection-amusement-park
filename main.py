...
if __name__ == "__main__":
    ...
    achor_YUNET_input_size_nr_list = [320, 480, 640, 960, 1280, 1600, 1920, 2560]  # Different input sizes to test
    score_threshold_list = [i/10 for i in range(2, 10)]  # Score thresholds from 0 to 100 in steps of 10
    nms_threshold_list = [i/10 for i in range(2, 10)]
    top_k = 100
    test_number_iter = 6
    run_number = 1
